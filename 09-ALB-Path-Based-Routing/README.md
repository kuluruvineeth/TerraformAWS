...
1. Fixed Response for /* : http://apps.onspot.click   
2. App1 /app1* goes to App1 EC2 Instances: http://apps.onspot.click/app1/index.html
3. App2 /app2* goes to App2 EC2 Instances: http://apps.onspot.click/app2/index.html
4. HTTP to HTTPS Redirect

## Step-02: Copy all files from previous section 
- We are going to copy all files from previous section `08-AWS-ALB-Application-LoadBalancer-Basic`
...
1. Fixed Response: http://apps.onspot.click   
2. App1 Landing Page: http://apps.onspot.click/app1/index.html
3. App1 Metadata Page: http://apps.onspot.click/app1/metadata.html
4. App2 Landing Page: http://apps.onspot.click/app2/index.html
5. App2 Metadata Page: http://apps.onspot.click/app2/metadata.html
```
